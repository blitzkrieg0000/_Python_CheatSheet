...
class UserDefinedServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.__call__ = channel.unary_unary(
                ...
                request_serializer=ray__pb2.UserDefinedMessage.SerializeToString,
                response_deserializer=ray__pb2.UserDefinedResponse.FromString,
                )
        self.Multiplexing = channel.unary_unary(
                '/userdefinedprotos.UserDefinedService/Multiplexing',
                request_serializer=ray__pb2.UserDefinedMessage2.SerializeToString,
                response_deserializer=ray__pb2.UserDefinedResponse2.FromString,
                )
...
def add_UserDefinedServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            '__call__': grpc.unary_unary_rpc_method_handler(
                    servicer.__call__,
                    request_deserializer=ray__pb2.UserDefinedMessage.FromString,
                    response_serializer=ray__pb2.UserDefinedResponse.SerializeToString,
            ),
            'Multiplexing': grpc.unary_unary_rpc_method_handler(
                    servicer.Multiplexing,
                    request_deserializer=ray__pb2.UserDefinedMessage2.FromString,
                    response_serializer=ray__pb2.UserDefinedResponse2.SerializeToString,
            ),
...
class UserDefinedService(object):
    ...
    def __call__(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/userdefinedprotos.UserDefinedService/__call__',
            ray__pb2.UserDefinedMessage.SerializeToString,
            ray__pb2.UserDefinedResponse.FromString,
    ...
    def Multiplexing(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/userdefinedprotos.UserDefinedService/Multiplexing',
            ray__pb2.UserDefinedMessage2.SerializeToString,
            ray__pb2.UserDefinedResponse2.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
...
class ImageClassificationServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.Predict = channel.unary_unary(
                ...
                request_serializer=ray__pb2.ImageData.SerializeToString,
                response_deserializer=ray__pb2.ImageClass.FromString,
                )
...
def add_ImageClassificationServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'Predict': grpc.unary_unary_rpc_method_handler(
                    servicer.Predict,
                    request_deserializer=ray__pb2.ImageData.FromString,
                    response_serializer=ray__pb2.ImageClass.SerializeToString,
            ),
    }
    generic_handler = grpc.method_handlers_generic_handler(
...
class ImageClassificationService(object):
    ...
    def Predict(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/userdefinedprotos.ImageClassificationService/Predict',
            ray__pb2.ImageData.SerializeToString,
            ray__pb2.ImageClass.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
